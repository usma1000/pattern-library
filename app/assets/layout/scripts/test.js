...
var Layout = function () {
    ...
    var handleMainMenu = function () {
        ...
        $(window).scroll(function() {                
            var offset = 220; // demo_header1.html
...
//        $('#staff-profile main aside h1').addClass('visible-xs-block');
//        $('#staff-profile main section h1:first-of-type').addClass('visible-sm-block');
//        $('#staff-profile main section h1:first-of-type').addClass('visible-md-block');
//        $('#staff-profile main section h1:first-of-type').addClass('visible-lg-block');
//        $('#staff-profile main section:first-of-type').addClass('clearfix');
